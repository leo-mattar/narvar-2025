...
//     on: {
//       init: function () {
//         const original = document.querySelector(".swiper-pagination.hm-hero");
//         if (original) original.style.display = "none";

//         // Clone pagination and attach events
//         clonePaginationAndAttachEvents(this);

//         // Update active bullet on init
//         updateClonedActiveBullet(this);
//       },
//     },
//   });

//   slider.on("slideChange", function () {
//     updateClonedActiveBullet(slider);
//   });

//   // Function to clone pagination and attach events
//   function clonePaginationAndAttachEvents(sliderInstance) {
//     const swiperPagination = document.querySelector(".swiper-pagination.hm-hero");
//     const slides = document.querySelectorAll(".swiper-slide.hm-hero");
...
//   // Function to update the cloned pagination bullets
//   function updateClonedActiveBullet(sliderInstance) {
//     document
//       .querySelectorAll(
//         ".swiper-slide.hm-hero .holder-slide-pagination-placeholder .swiper-pagination.hm-hero")
//       .forEach(clonedPagination => {
//         const bullets = clonedPagination.querySelectorAll(".swiper-pagination-bullet");
//         bullets.forEach((bullet, index) => {
//           bullet.classList.toggle("swiper-pagination-bullet-active", index === sliderInstance
//             .realIndex);
//         });
//       });
//   }
